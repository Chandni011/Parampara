...
public class Ayojan_Adapter extends RecyclerView.Adapter<Ayojan_Adapter.ViewHolder> {
    private Activity activity;
    private List<Ayojan_list> data;

    public Ayojan_Adapter(Activity activity, List<Ayojan_list> data) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View v = inflater.inflate(R.layout.item_ayojan, parent, false);
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        holder.Ayojanname.setText(data.get(position).getayojan_name().trim());
