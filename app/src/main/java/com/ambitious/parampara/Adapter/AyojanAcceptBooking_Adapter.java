...
import com.ambitious.parampara.Model.bhavya.BhvyaAccedptedResult;
...
public class AyojanAcceptBooking_Adapter extends RecyclerView.Adapter<AyojanAcceptBooking_Adapter.ViewHolder> {
    private Activity activity;
    private List<BhvyaAccedptedResult> task;
    ...
    public AyojanAcceptBooking_Adapter(Activity activity, List<BhvyaAccedptedResult> task, int flag) {
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        ...
        puja = task.get(position).getAyojanName();
