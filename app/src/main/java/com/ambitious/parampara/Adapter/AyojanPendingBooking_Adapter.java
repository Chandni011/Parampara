...
import com.ambitious.parampara.Model.bhavya.BhavyaPendingResult;
...
public class AyojanPendingBooking_Adapter extends RecyclerView.Adapter<AyojanPendingBooking_Adapter.ViewHolder> {
    private String strImage;
    private String strusername;
    private Activity activity;
    private List<BhavyaPendingResult> task;
    TextView username;
    CircleImageView cv_userImage;


    public AyojanPendingBooking_Adapter(Activity activity, List<BhavyaPendingResult> task) {
    ...
    @Override
    public AyojanPendingBooking_Adapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_accepted, parent, false);
        return new AyojanPendingBooking_Adapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(final AyojanPendingBooking_Adapter.ViewHolder holder, final int position) {
        holder.booking_id.setText("Booking Id : " + task.get(position).getBookingId());
        holder.poojaname.setText("Ayojan : " + task.get(position).getAyojanName());
