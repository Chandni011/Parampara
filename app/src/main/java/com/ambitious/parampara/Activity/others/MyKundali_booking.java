...
public class MyKundali_booking extends AppCompatActivity {
    SwipeRefreshLayout swipe;
    RecyclerView rec_requestlist;
    ArrayList<Kundali_list> data = new ArrayList<>();
    String userID;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_my_kundali_booking);
        ...
        txt_headername.setText("Kundali");
    ...
    private void getKundali() {
        swipe.setRefreshing(true);
        Call<ResponseBody> call = AppConfig.loadInterface().get_kundali_booking(userID);
            ...
            public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                ...
                if (response.isSuccessful()) {
                    try {
                        ...
                        if (error.equals("1")) {
                            Gson gson = new Gson();
                            MyKundali_Response resquestList_response = gson.fromJson(responedata, MyKundali_Response.class);
                            rec_requestlist.setHasFixedSize(true);
                            RecyclerView.LayoutManager mLayoutManager1 = new LinearLayoutManager(MyKundali_booking.this);
                            rec_requestlist.setLayoutManager(mLayoutManager1);
                            rec_requestlist.setItemAnimator(new DefaultItemAnimator());
                            Kundali_Adapter adapter = new Kundali_Adapter(MyKundali_booking.this, resquestList_response.getResult());
